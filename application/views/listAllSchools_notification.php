                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <table class="table table-bordered table-hover dataTable" id="sample">
                                <thead>
                                    <tr>
                                      <th>Donor Name</th>
                                      <th>School</th>
                                ...
                                <tbody class="periods">
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $val["tcn_schoolCode"] ?> <?php echo ($val["tcn_status"] == 0)?'<sup><small style="color:#f00;">New</small></sup>':'' ?></td>
                                    <td><a href="<?php echo CONNECTAPP_URL."uploads/".$val["tcn_img"] ?>" class="content"><img src="<?php echo CONNECTAPP_URL."uploads/".$val["tcn_img"] ?>" style="max-height:30px;"></a></td>
                                  </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
