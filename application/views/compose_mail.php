            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Send Individual Email</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-envelope"></i> Send Individual Email</h4>
                        </div>
...
<script type="text/javascript">
    ...
    function showDonors(){
      $("#showLoading").show();
      $.ajax({
        url: BASE_URL + 'administration/loadDonors/0',
        type: "POST",
