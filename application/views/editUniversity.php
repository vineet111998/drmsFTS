    ...
    <div id="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        <?php echo ($edit) ? "Edit" : "Add"; ?> University
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                        ...
                        <div class="widget-body form">
                            ...
                            <form action="<?php echo current_url() ?>" class="form-horizontal" method="POST">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="UNIV[mu_name]" class="span6" value="<?=$university["mu_name"]?>" required/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">University Address</label>
                                    <div class="controls">
                                        <input type="text" name="UNIV[mu_address]" class="span6" value="<?=$university["mu_address"]?>" required/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">About University</label>
                                    <div class="controls">
                                        <textarea name="UNIV[mu_about]" class="span6" required><?=$university["mu_about"]?></textarea>
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label">Edit Degrees</label>
                                    <div class="controls">
                                        <a href="<?php echo base_url("universities/editDegrees/".$university["mu_id"])?>" class="btn btn-small btn-primary">Update Degrees</a>
                                    </div>
                                </div>
