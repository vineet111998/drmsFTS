                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="<?php echo base_url('drm/listSchools/'.$val["md_id"]."/".$fromState)?>" class="btn btn-primary btn-small"><i class="icon-briefcase"></i> Schools</a>
                                          <a href="<?php echo base_url('administration/fetchSchools/'.$val["md_id"]."/".$fromState)?>" class="btn btn-small content"><i class="icon-file"></i> Report</a>
                                        </td>
                                    </tr>
                                    <?php } endforeach;?>
                                </tbody>
